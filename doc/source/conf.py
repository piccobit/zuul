...
latex_documents = [
  ('index', 'Zuul.tex', 'Zuul Documentation',
   'OpenStack', 'manual'),
]
...
man_pages = [
    ('index', 'zuul-server', 'Zuul Documentation',
     ['OpenStack'], 1)
]
...
texinfo_documents = [
  ('index', 'Zuul', 'Zuul Documentation',
   'OpenStack', 'Zuul', 'One line description of project.',
   'Miscellaneous'),
]
